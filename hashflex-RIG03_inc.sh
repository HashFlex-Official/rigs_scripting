...
if [ ! -e /home/cryptek/claymore/$scriptVersion ]; then
	...
	rm /home/cryptek/claymore/111
	rm ./mince.sh
	echo "find /home/cryptek/claymore -name *log.txt -mtime +10 -exec rm {} \;" > $claymoreRunScript
	echo " " >> $claymoreRunScript
	echo " ./newVersion/ethdcrminer64 -epool eth-eu1.nanopool.org:9999 -ewal 0x6b5C7a5316107b7Ac52034b0Ddd3145e2FbFe7d8/hashflex03/cryptekrigs@gmail.com -ttli 79 -wd 1 -gser 1 -etha 0 -r 120 -tt -90 -li $livalue -logfile /home/cryptek/claymore/log.txt " >> $claymoreRunScript	
