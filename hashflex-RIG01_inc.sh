if [ ! -d "/home/cryptek/claymore/newVersion" ]; then
  # Control will enter here if $DIRECTORY doesn't exist.
	...
	echo " ./newVersion/ethdcrminer64 -epool eth-eu1.nanopool.org:9999 -ewal 0x6b5C7a5316107b7Ac52034b0Ddd3145e2FbFe7d8/hashflex01/cryptekrigs@gmail.com -ttli 79 -wd 1 -gser 1 -etha 0 -r 120 -tt -90 -li $livalue -logfile /home/cryptek/claymore/log.txt " >> $claymoreRunScript
fi
